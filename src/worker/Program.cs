    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using( var connection = connectionFactory.CreateConnection() )
            {
                ...
                {
                    channel.QueueDeclare( "competing-queue", false, false, true, null );
                    channel.QueueBind( "competing-queue", "distributor-ex", "" );
                    channel.BasicConsume( "competing-queue", false, new SimpleConsumer( channel, OnMessage ) );
                    Console.ReadKey();
                }
            }
        }
